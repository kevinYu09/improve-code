...
describe('Validate JS configs', () => {
  it('Validate improve-code-eslint-config', async () => {
  ...
  it('Validate improve-code-eslint-config/es5', async () => {
  ...
  it('Validate improve-code-eslint-config/vue', async () => {
  ...
  it('Validate improve-code-eslint-config/essential', async () => {
  ...
  it('Validate improve-code-eslint-config/essential/es5', async () => {
  ...
  it('Validate improve-code-eslint-config/essential/react', async () => {
  ...
  it('Validate improve-code-eslint-config/essential/vue', async () => {
  ...
  it('Validate improve-code-eslint-config/node', async () => {
