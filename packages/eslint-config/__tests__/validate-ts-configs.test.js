...
describe('Validate TS configs', () => {
  it('Validate improve-code-eslint-config/typescript', async () => {
  ...
  it('Validate improve-code-eslint-config/typescript/vue', async () => {
  ...
  it('Validate improve-code-eslint-config/essential/typescript', async () => {
  ...
  it('Validate improve-code-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate improve-code-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate improve-code-eslint-config/typescript/node', async () => {
