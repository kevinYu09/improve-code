...
- 2.5.1.【参考】尽量根据语义使用 HTML 标签。
  ...
  应优先选取符合当下所需语义的标签，这既有助于[可访问性（Accessibility）](https://developer.mozilla.org/zh-CN/docs/learn/Accessibility)，也可以在 CSS 加载失败时获得较好的展示效果。
...
<html lang="zh-CN">
  <head>
    <meta charset="utf-8" />
    <meta name="description" content="前端工程化 - 一千个职业梦想的赞助商" />
