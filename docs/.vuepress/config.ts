  ...
  themeConfig: {
    nav: [
      ...
      },
      {
        text: 'NPM包',
        items: [
          { text: 'eslint-config-improve-code', link: '/npm/eslint.md' },
          { text: 'stylelint-config-improve-code', link: '/npm/stylelint.md' },
          { text: 'commitlint-config-improve-code', link: '/npm/commitlint.md' },
    ...
    sidebar: [
      ...
      },
      {
        title: 'NPM包',
        children: [
          { title: 'eslint-config-improve-code', path: '/npm/eslint.md' },
          { title: 'stylelint-config-improve-code', path: '/npm/stylelint.md' },
    ...
    logo: '/img/logo.png',
    repo: 'kevinYu09/improve-code',
    searchMaxSuggestions: 10,
    docsDir: 'docs',
    footer: {
      createYear: 2024,
      copyrightInfo:
        'kevinYu09 improve-code | <a href="https://github.com/kevinYu09/improve-code" target="_blank">github</a>',
    },
